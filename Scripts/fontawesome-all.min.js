...
!function() {
        ...
        Z = function(c) {
            var l = c.children,
                ...
                M = {
                    ...
                    children: [{
                        tag: "path",
                        attributes: S({}, a.attributes, f.path, {
                            fill: "black"
                        })
                    }]
                },
    ...
    function hc(c) {
        var l = c.icons,
            ...
            V = [O.replacementClass, e ? O.familyPrefix + "-" + e : "", H].concat(t.classes).join(" "),
            C = {
                children: [],
    ...
    var zc = function() {},
        ec = O.measurePerformance && f && f.mark && f.measure ? f : {
            mark: zc,
            measure: zc
        },
        mc = 'FA "5.0.12"',
        ...
        tc = function(c, l, h, v) {
            var z,
                ...
                t = Object.keys(c),
                f = t.length,
                r = void 0 !== v ? (a = l, s = v, function(c, l, h, v) {
                    return a.call(s, c, l, h, v)
                }) : l;
            for (void 0 === h ? (z = 1, m = c[t[0]]) : (z = 0, m = h); z < f; z++)
                m = r(m, c[e = t[z]], e, c);
            return m
        },
        fc = E.styles,
    ...
    function Cc(c) {
        return c.reduce(function(c, l) {
            ...
            if (Vc[l])
                ...
                l !== O.replacementClass && 0 !== l.indexOf("fa-w-") && c.rest.push(l);
            return c
        }, oc())
    }
    function Lc(c, l, h) {
    ...
    var bc = {
        replace: function(c) {
            ...
            if (l.parentNode && l.outerHTML)
                l.outerHTML = h + (O.keepOriginalSource && "svg" !== l.tagName.toLowerCase() ? "\x3c!-- " + l.outerHTML + " --\x3e" : "");
        ...
        nest: function(c) {
            var l = c[0],
                h = c[1];
            if (~X(l).indexOf(O.replacementClass))
                return bc.replace(c);
    ...
    var kc = function(c) {
            var l,
                ...
                s = Cc(X(c));
            return e && m && (s.prefix = e, s.iconName = m), s.prefix && a.length > 1 ? s.iconName = (v = s.prefix, z = c.innerText, ic[v][z]) : s.prefix && 1 === a.length && (s.iconName = (l = s.prefix, h = function(c) {
    ...
    function Dc(c, l) {
        ...
        if (c && l && Ic[l] && Ic[l][c]) {
            ...
            throw new Nc("Icon is missing for prefix " + l + " with icon name " + c);
        return h
    }
    function Xc(c) {
        var l,
            ...
            L,
            u,
            d = (h = kc(l = c), v = h.iconName, z = h.prefix, e = h.rest, m = Sc(l), a = Ac(l), s = qc(l), t = Oc(l), f = jc(l), {
                iconName: v,
                    ...
                    [":before", ":after"].forEach(function(l) {
                        ...
                        if (z && (z.nextSibling && z.nextSibling.textContent.indexOf(C) > -1 && Yc(z.nextSibling), Yc(z), z = null), v && !z) {
                            var e = h.getPropertyValue("content"),
                                m = s.createElement("i");
                            m.setAttribute("class", "" + Bc[v[1]]), m.setAttribute(C, l), m.innerText = 3 === e.length ? e.substr(1, 1) : e, ":before" === l ? c.insertBefore(m, c.firstChild) : c.appendChild(m)
                        }
                    })
                })
            }(), yc = !1, l()
    ...
    function Kc(c) {
        ...
        if (M) {
            var h = s.documentElement.classList,
                ...
                e = Object.keys(Ic),
                m = ["." + Rc + ":not([" + o + "])"].concat(e.map(function(c) {
                    return "." + c + ":not([" + o + "])"
                })).join(", ");
            if (0 !== m.length) {
            ...
            value: function() {
                ...
                Object.keys(z).forEach(function(l) {
                    c.definitions[l] = S({}, c.definitions[l] || {}, z[l]), function c(l, h) {
                        ...
                        "function" == typeof E.hooks.addPack ? E.hooks.addPack(l, v) : E.styles[l] = S({}, E.styles[l] || {}, v), "fas" === l && c("fa", h)
                    }(l, z[l])
                })
            }
        }, {
    ...
    function hl(c) {
        var l = c.prefix,
            ...
            v = c.iconName;
        if (v)
            return Lc(zl.definitions, h, v) || Lc(E.styles, h, v)
    }
    var vl,
        zl = new Qc,
        el = (vl = function(c) {
    ...
    Object.defineProperty(ml, "config", {
        ...
        r && (a.FontAwesome || (a.FontAwesome = ml), T(function() {
